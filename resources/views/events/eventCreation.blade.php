...
<div class="container bg-white rounded-0 border p-3">
  ...
  <form action="{{ route('events.newEvent') }}" method="post" class="form">
    ...
    <div class="row">
      <div class="form-group col">
        ...
        <input type="text" name="name" id="name" class="form-control rounded-0" placeholder="Nom de l'événement">
      </div>
      <div class="form-group col">
        <label for="location">Lieu de l'événement</label>
        <input type="text" name="location" id="location" class="form-control rounded-0" placeholder="Lieu de l'événement">
      </div>
    </div>
