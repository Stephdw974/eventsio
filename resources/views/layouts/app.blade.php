            ...
            <div class="container p-0">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item">
                            @auth
                            <a class="nav-link" href="{{ route('home.showMe') }}">{{ Auth::user()->name }}<i class="fas fa-user ml-3"></i></a>
                            @else
                            <a class="nav-link" href="{{ route('login') }}"> Se connecter <i class="fas fa-sign-in-alt ml-3"></i></a>
                            @endauth
                        </li>
                    </ul>
